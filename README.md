...
<p><em><img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30"> <h3>Software Engineer And Flutter Developer</h3><a href="/">
</a>
</em></p>
...
<!--END_SECTION:waka-->￼Enter        devOps: ["AWS"],
        databases: ["mongo", "MySql", "sqlite", "SQL Server"],
        misc: ["Firebase", "Socket.IO"]
    },
    architecture: ["Serverless Architecture", "Progressive web applications", "Single page applications"],
